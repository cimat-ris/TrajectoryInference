...
class plotter():
	def __init__(self,coordinate_system="img",title=None):
		self.coordinate_system = coordinate_system
		self.fig,self.ax = plt.subplots(1, figsize=(14, 8))
		plt.margins(0, 0)
		...
		if coordinate_system!="img":
			scalebar = AnchoredSizeBar(self.ax.transData,
						10, '10 m', 'lower left',
						pad=0.05,frameon=False,size_vertical=0.2)
